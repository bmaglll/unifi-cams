...
- **Notifications** — Webhook server receives UniFi Protect events and sends desktop notifications with camera thumbnails. Click to open a live PIP stream. Supports any event type available in the Protect controller (motion, person, vehicle, package, etc.).
